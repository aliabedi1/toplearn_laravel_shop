                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach ($payments as $payment )
                        ...
                        <tr>
                            ...
                            <td>{{ $payment->paymentable->transaction_id ?? 'ندارد'}}</td>
                            <td>{{ $payment->paymentable->gateway ?? 'ندارد'}}</td>
                            <td>{{ $payment->user->fullname }}</td>
                            <td> @if ($payment->status == 0) پرداخت نشده @elseif ($payment->status == 1 ) پرداخت شده @elseif ($payment->status == 2) لغو شده @else برگشت داده شده @endif</td>
