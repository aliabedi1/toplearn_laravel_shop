                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      @foreach ($comments as $key => $comment)
                        ...
                        <tr>
                            <th>{{ $key + 1 }}</th>
                            <td>{{ Str::limit($comment->body, 12, '...') }}</td>
                            <td>{{ $comment->parent_id ? Str::limit($comment->parent->body, 12, '...') : ''}}</td>
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <a href="{{ route('admin.market.comment.approved', $comment->id) }}" class="btn btn-warning btn-sm text-white" type="submit"><i class="fa fa-clock"></i> عدم تایید</a>
                                @else
