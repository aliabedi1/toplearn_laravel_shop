                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" id="" class="form-control form-control-sm">
                                        ...
                                        @foreach ($productCategories as $selectProductCategories)
                                        <option value="{{ $selectProductCategories->id }}" @if(old('parent_id',$menu->parent_id) == $selectProductCategories->id) selected @endif>{{ $selectProductCategories->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('parent_id')
