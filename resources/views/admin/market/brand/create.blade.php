                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="persian_name" id="persian_name" value="{{ old('persian_name') }}">
                            </div>
                            @error('persian_name')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="original_name" id="original_name" value="{{ old('original_name') }}">
                            </div>
                            @error('original_name')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
