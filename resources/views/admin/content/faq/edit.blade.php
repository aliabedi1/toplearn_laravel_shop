...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش سوالات</li>
    </ol>
  </nav>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 my-2">
                            <div class="form-group">
                                ...
                                <textarea  id="question" name="question" class="form-control form-control-sm" rows="6">{{ old('question',$faq->question) }}</textarea>
                        ...
                        <section class="col-12 my-2">
                            <div class="form-group">
                                ...
                                <textarea  id="body" name="answer" class="form-control form-control-sm" rows="6">{{ old('answer',$faq->answer) }}</textarea>
                            </div>
