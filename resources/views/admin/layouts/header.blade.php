                                ...
                                <li class="list-group-item list-group-item-action">
                                    <section class="media">
                                        <section class="media-body pr-1">
                                            ...
                                            <p class="notification-time">{{ jalaliDateAgo($notification->created_at) }}</p>
                                        </section>
                                    </section>
                                </li>
                            @endforeach
                    ...
                    <section id="header-comment" class="header-comment">
                        ...
                        <section class="header-comment-wrapper">
                            <ul class="list-group rounded px-0">
                                ...
                                <a class="text-dark text-decoration-none" href="{{ route($unseenComment->commentableRouteName, $unseenComment->id) }}">
                                    <li class="list-group-item list-groupt-item-action">
                                        <section class="media">
                                            <img src="{{ asset( $unseenComment->user->profile_photo_path ) }}" alt="avatar" class="notification-img my-3">
                                            <section class="media-body pr-1">
                                                <section class="d-flex justify-content-between">
                                                    <h5 class="comment-user mt-4">{{ $unseenComment->user->fullName }}</h5>
                                                    <h5 class="comment-user mt-4"> - </h5>
                                                    <h5 class="comment-user mt-4">{{ jalaliDate($unseenComment->created_at) }}</h5>
                                                    <h5 class="comment-user mt-4"> </h5>
                                                    <span class=""><i class="fas fa-circle text-success comment-user-status"></i></span>
                                                </section>
                                            </section>
                                        </section>
                                    </li>    
