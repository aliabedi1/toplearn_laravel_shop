                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input name="first_name" type="text" class="form-control form-control-sm" id="first_name" value="{{ old('first_name', $admin->first_name) }}">
                            </div>
                            @error('first_name')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input name="last_name" id="last_name" value="{{ old('last_name', $admin->last_name) }}" type="text" class="form-control form-control-sm">
                            </div>
                            @error('last_name')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
