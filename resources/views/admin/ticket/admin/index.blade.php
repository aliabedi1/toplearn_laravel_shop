                    ...
                    @foreach ($admins as $key => $admin )
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.ticket.admin.set' , $admin->id) }}" class="btn btn-{{ $admin->ticketAdmin == null ? 'info' : 'danger'  }} btn-sm"><i class="fa fa-{{ $admin->ticketAdmin == null ? 'check' : 'trash'  }}"></i>
