...
class ImageService extends ImageToolsService
{
    ...
    public function createIndexAndSave($image)
    {
            ...
            foreach($imageSizes as $sizeAlias => $imageSize)
            {
                ...
                if($sizeAlias == 'large')
                {
                    $result = Image::make($image->getRealPath())->fit(800,600)->save(public_path($this->getImageAddress()), null, $this->getImageFormat());
                }
                ...
                {
                    $result = Image::make($image->getRealPath())->fit(80,60)->save(public_path($this->getImageAddress()), null, $this->getImageFormat());
                }
