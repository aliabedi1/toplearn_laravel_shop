...
class CreateOrderItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->decimal('amazing_sale_discount_amount',20,3)->nullable()->comment('toman');
            $table->integer('number')->comment('count');
            $table->decimal('final_product_price',20,3);
            $table->decimal('final_total_price',20,3)->comment('numer x final_product_price');
